...
export const brandingDefaults: BrandingConfig = {
  ...
  theme: {
    ...
    // Vanilla declares its palette in the webapp's own stylesheets; a brand that overrides nothing
    // adds nothing here (consumers fall back to FRAMEWORK_TOKENS).
    tokens: {},
  },
  group: {
    nameLengthMin: 3,
