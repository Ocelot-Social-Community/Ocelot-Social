...
export const BUCKET_PATHS: Record<BucketName, string[]> = {
  ...
  // `assets.iconSizes` rides with the icon it measures: split apart, a composed instance could take
  // one brand's icon and another's dimensions.
  logos: ['logos', 'assets.favicon', 'assets.icon', 'assets.iconSizes'],
