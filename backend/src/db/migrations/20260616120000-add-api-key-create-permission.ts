...
export const description =
  'Grant the new apiKey.create permission to every existing non-owner role, preserving parity: creating personal API keys (previously open to any authenticated user when the feature is enabled) keeps working after createApiKey becomes permission-gated. Owner expands to the full catalog and needs no stored entry. Idempotent.'

const PERMISSION = 'apiKey.create'
