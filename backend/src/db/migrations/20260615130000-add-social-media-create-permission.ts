...
export const description =
  'Grant the new socialMedia.create permission to every existing non-owner role, so adding social-media links (previously open to any authenticated user) keeps working after CreateSocialMedia becomes permission-gated. Owner expands to the full catalog and needs no stored entry. Idempotent.'

const PERMISSION = 'socialMedia.create'
