...
import DeleteUser from '@graphql/queries/DeleteUser.gql'
import resetTrophyBadgesSelected from '@graphql/queries/resetTrophyBadgesSelected.gql'
...
import switchUserRole from '@graphql/queries/switchUserRole.gql'
import updateOnlineStatus from '@graphql/queries/updateOnlineStatus.gql'
import UpdateUser from '@graphql/queries/UpdateUser.gql'
import userQuery from '@graphql/queries/User.gql'
import UserEmailNotificationSettings from '@graphql/queries/UserEmailNotificationSettings.gql'
